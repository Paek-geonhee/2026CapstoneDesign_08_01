...
from Modules.Utility import combine_to_7d_tensor, load_and_downsample, combine_to_7d, normalize_features
from Modules.Trajectory import build_weathering_trajectory, resample_trajectory
from Modules.KNN import Get_KNN_Graph_Adaptive
from Modules.MDS import Get_MDS_graph

from Modules._Reconstructor import build_weathering_interpolation_path, export_texture_set
...
class WeatheringPipeline:
    ...
    _SAVE_PATH = os.path.join(unreal.Paths.project_saved_dir(), "WeatheringResults", ".npy")
